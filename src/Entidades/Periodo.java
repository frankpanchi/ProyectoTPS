...
@NamedQueries({
    ...
    @NamedQuery(name = "Periodo.findByIdCalificacion", query = "SELECT p FROM Periodo p WHERE p.idCalificacion = :idCalificacion")})
public class Periodo implements Serializable {
    ...
    private BigInteger idCalificacion;
    ...
    public BigInteger getIdCalificacion() {
        return idCalificacion;
    }

    public void setIdCalificacion(BigInteger idCalificacion) {
